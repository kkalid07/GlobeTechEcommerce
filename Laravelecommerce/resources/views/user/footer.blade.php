                ...
                <div class="col-lg-4 col-md-6">
                    <div class="widget-about font-md mb-md-5 mb-lg-0">
                        ...
                        <p class="wow fadeIn animated">
                            <strong>Address: </strong>John Doe123 Maple Street, Apt 4BBrooklyn, NY 11201 United States
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Phone: </strong>+1 555-123-4567
                        </p>
                        <p class="wow fadeIn animated">
                            <strong>Email: </strong>contact@GlobeTechnologies.in
                        </p>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <p class="text-lg-end text-start font-sm text-muted mb-0">
                    &copy; <strong class="text-brand">GlobeTechnologies</strong> All rights reserved
                </p>
            </div>
        </div>
    </div>
