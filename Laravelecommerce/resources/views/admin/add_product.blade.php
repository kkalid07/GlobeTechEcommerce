                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="screen_size" placeholder="ex: 15,6 inc" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="screen_resolution" placeholder="ex: 1920x1080" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="screen_refresh_rate" placeholder="ex: 144 Hz" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="device_weight" placeholder="ex: 2KG" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="processor" placeholder="ex: 12650H" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="processor_generation" placeholder="ex: 12" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="processor_type" placeholder="ex: Core i7" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="processor_speed" placeholder="ex: 2.4GH" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="graphics_type" placeholder="ex: Nvidia GeForce RTX" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="graphics_card_memory" placeholder="ex: 6GB" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="ram" placeholder="ex: 16GB" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="ssd_capacity" placeholder="ex: 1TB" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="keyboard" placeholder="ex: Q Turkish" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="color" placeholder="ex: Silver" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input name="operating_system" placeholder="ex: Windows 11 Pro" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
