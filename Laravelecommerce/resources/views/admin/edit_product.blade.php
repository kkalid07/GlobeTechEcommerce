                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->screen_size}}" name="screen_size" placeholder="ex: 15,6 inc" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->screen_resolution}}" name="screen_resolution" placeholder="ex: 1920x1080" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->screen_refresh_rate}}" name="screen_refresh_rate" placeholder="ex: 144 Hz" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->device_weight}}" name="device_weight" placeholder="ex: 2KG" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->processor}}" name="processor" placeholder="ex: 12650H" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->processor_generation}}" name="processor_generation" placeholder="ex: 12" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->processor_type}}" name="processor_type" placeholder="ex: Core i7" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->processor_speed}}" name="processor_speed" placeholder="ex: 2.4GH" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->graphics_type}}" name="graphics_type" placeholder="ex: Nvidia GeForce RTX" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->graphics_card_memory}}" name="graphics_card_memory" placeholder="ex: 6GB" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->ram}}" name="ram" placeholder="ex: 16GB" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->ssd_capacity}}" name="ssd_capacity" placeholder="ex: 1TB" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->keyboard}}" name="keyboard" placeholder="ex: Q Turkish" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->color}}" name="color" placeholder="ex: Silver" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <input value="{{$product->operating_system}}" name="operating_system" placeholder="ex: Windows 11 Pro" type="text" class="form-control" style="color: #fff" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
